...
rem TMP is used for a temporary dir to combine the mod with the support files
set TMP=tmp
...
xcopy /y /s /I %GAMEDATA%\%GAMEDIR% %TMP%\%GAMEDATA%\%GAMEDIR%
xcopy /y /s /i %SUPPORTFILES% %TMP%
